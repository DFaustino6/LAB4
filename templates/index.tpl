              ...
              <div class="row" style="padding: 1%; "> 
                <div class="col-sm-7">
                  <h4 style="color: white"> Created:{$post.created_at}</h4>
                      ...
                      <div class="col-sm-5">
                        <button type="button" class="btn btn-success right-align"><span class="glyphicon glyphicon-arrow-up"></span>&nbsp;{$post.upvotes}</button>
                          
                        <button type="button" class="btn btn-danger right-align"> <span class="glyphicon glyphicon-arrow-down"></span>&nbsp;{$post.downvotes}</button>
                      </div>  
                    </div>
                  </div>  
          </div>
